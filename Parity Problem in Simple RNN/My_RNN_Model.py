...
class SimpleRNN:
    ...
    def fit(self, X, Y, learning_rate = 0.1, mu = 0.99, reg = 1.0,
...
def parity(X = X, Y = Y, learning_rate = 1e-4, epochs = 200):
    
    rnn_model = SimpleRNN(20)
    rnn_model.fit(X, Y, learning_rate = learning_rate, epochs = epochs,
