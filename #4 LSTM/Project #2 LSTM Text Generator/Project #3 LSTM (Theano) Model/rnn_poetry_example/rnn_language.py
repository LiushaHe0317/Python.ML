...
class SimpleRNN:
    ...
    def fit(self, X, learning_rate=1., mu=0.99, reg=1.0, activation=T.tanh, 
    ...
    def generate(self, pi, word2idx):
        ...
        idx2word = {v:k for k,v in iter(word2idx.items())}
        V = len(pi)
...
def train_poetry():
    ...
    rnn.fit(sentences, learning_rate = 1e-4, show_fig = True, 
            activation = T.nnet.relu, epochs = 5000)
